...
export function generateFirstMirror(calc: CalculationResult): FirstMirror {
  ...
  return {
    ...
    cta: {
      ...
      text: "В Telegram можно выбрать одну живую ситуацию и увидеть, какие позиции и составные маршруты поддерживают вывод. После разбора останется один шаг для проверки в течение семи дней.",
