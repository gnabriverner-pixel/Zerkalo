...
export default function Storytelling() {
  ...
  const applyFallback = () => {
    setResult({
      title: "Отражение",
      story: "Сейчас сказку не удалось собрать. Вы можете сохранить ответы и вернуться позже.",
      mirror: {
      ...
      <div className="w-full max-w-2xl flex flex-col items-center">
        ...
        <AnimatePresence mode="wait">
          {step === 0 && (
            ...
            >
              <h1 className="font-serif text-5xl md:text-6xl mb-4 text-[#F4F4F4]">Сказка</h1>
