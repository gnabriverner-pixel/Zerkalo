            ...
            >
              ...
              <div className="bg-white/[0.015] backdrop-blur-xl border border-white/5 rounded-3xl p-8 md:p-12 mb-12 shadow-xl max-w-xl mx-auto">
                <p className="font-serif text-[1.1rem] md:text-lg text-gray-300 leading-relaxed italic">
                  Это бережное образное путешествие — сказка, созданная про вас и для вас. Она помогает посмотреть на текущее состояние через поэтические метафоры, мягко распутать фоновые мысли и найти в глубине себя тихий источник силы и самоценности.
                </p>
              </div>
