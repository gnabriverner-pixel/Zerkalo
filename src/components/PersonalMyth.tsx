            ...
            >
              ...
              <div className="bg-white/[0.015] backdrop-blur-xl border border-white/5 rounded-3xl p-8 md:p-12 mb-12 shadow-xl max-w-xl mx-auto">
                <p className="font-serif text-[1.1rem] md:text-lg text-gray-300 leading-relaxed italic">
                  Это мягкая образная рефлексия, основанная на принципах эмоционально-образного подхода и косвенных внушений. Она помогает взглянуть на внутренние узлы напряжения через призму классических архетипов, отстраниться от мыслей и сделать один бережный шаг к ресурсу.
                </p>
              </div>
