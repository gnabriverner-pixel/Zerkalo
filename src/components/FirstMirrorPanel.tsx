      ...
      <div className="p-8 md:p-14 lg:p-20 relative z-10">
        <div className="text-center mb-14">
          ...
          <div className="mt-10 mb-6 relative">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-[var(--color-antique-gold)] opacity-5 blur-[50px] rounded-full pointer-events-none"></div>
            <h3 className="text-[0.65rem] tracking-[0.25em] uppercase text-[var(--color-muted)] mb-4 font-sans relative z-10">
              Архитектура Формулы
            </h3>
            <div className="inline-block border border-[var(--color-antique-gold)] border-opacity-30 p-6 md:p-8 bg-transparent relative z-10 shadow-sm backdrop-blur-sm">
