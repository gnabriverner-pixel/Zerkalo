...
const PLANETARY_ARCHETYPES = [
  ...
  { num: 9, planet: 'Марс (Мангала)', title: 'Защитник и Проводник Энергии', essence: 'Динамика, смелость, служение благородной цели, бескорыстная отдача', shadow: 'Вспыльчивость, нетерпение, склонность к конфликтам на пустом месте', element: 'Огонь / Действие' }
];
              ...
              >
                ...
                <div className={`p-6 sm:p-8 border rounded-sm ${
                  ...
                  <p className="font-sans text-sm sm:text-base leading-relaxed opacity-90 mb-4">
                    Цифровой Код опирается на современную традицию ведической нумерологии — систему интерпретаций, выросшую из более широкой индийской символической и астрологической традиции и развиваемую современными исследователями и практиками.
                  </p>
                  <p className="font-sans text-sm sm:text-base leading-relaxed opacity-90">
                    Мы используем её как одну из гипотез о человеке: не как доказанный диагноз или научный факт, а как язык для самонаблюдения и проверки на собственном опыте.
                  </p>
                </div>
